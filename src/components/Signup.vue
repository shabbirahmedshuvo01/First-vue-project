                                    ...
                                    <div class="lg:w-6/12 px-4 md:px-0">
                                        <div class="md:p-12 md:mx-6">
                                            ...
                                            <section>
                                                ...
                                                <div class="mb-4">
                                                    <input
                                                        type="text" name="name" id="" v-model="name" placeholder='Your Name' required
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" />
                                                </div>
                                                <div class="mb-4">
                                                    <input
                                                        type="email" name="email" id="" v-model="email" placeholder='Email address' required
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" />
                                                </div>
                                                <div class="mb-4">
                                                    <input
                                                        type="password" name="password" id="" v-model="password" placeholder='Password' required
                                                        class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" />
                                                </div>
                                                <div class="text-center pt-1 mb-12 pb-1">
                                                    <!-- <input
                                                        ...
                                                        <button class="btn btn-success mt-2" v-on:click="signUp">submit</button>
